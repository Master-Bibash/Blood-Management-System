...
$sql = "INSERT INTO donor (username, gender, dob, bloodgroup, email, address, disease, contact, collection, available) 
VALUES ('$name', '$gender', '$dob', '$bloodgroup', '$email', '$address', '$disease', '$contact', '$collection', '$available')";
