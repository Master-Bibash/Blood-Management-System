				...
				if (isset($_POST['login']))
					{
                        ...
                        $query = mysqli_query($con, "SELECT * FROM admin WHERE password='$password' AND name='$username'");
...
<html lang="en">
    ...
    <body>
		...
		<nav class="navbar navbar-inverse">
			  <div class="container-fluid">
                ...
                <a class="navbar-brand" href="index.php"><i class="icofont-blood-drop"></i>Blood Management System</a>
				</div>
				...
				<ul class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="userlog/registration.php" ><span class="glyphicon glyphicon-user" style="color:#00A10F;"></span> Registration</a></li>
                  <li><a href="userlog/availabelbloodnow.php" ><span class="glyphicon glyphicon-user" style="color:#00A10F;"></span> Get Blood Now</a></li>
	...
	<footer class="page-footer font-small special-color-dark pt-4">
        ...
        Developed by Bibash,Sangita,Sindhu,Aman
		</div>
		<!-- Copyright -->
